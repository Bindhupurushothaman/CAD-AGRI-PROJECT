...
class PizzasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post pizzas_url, params: { pizza: { cost: @pizza.cost, description: @pizza.description, name: @pizza.name, size: @pizza.size } }
    end
  ...
  test "should update pizza" do
    patch pizza_url(@pizza), params: { pizza: { cost: @pizza.cost, description: @pizza.description, name: @pizza.name, size: @pizza.size } }
